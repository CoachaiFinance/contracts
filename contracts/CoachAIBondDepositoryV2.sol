...
/// @title CoachAI Bond Depository
/// @author Zeus, Indigo
/// Review by: JeffX

contract CoachAIBondDepositoryV2 is IBondDepository, NoteKeeper {
    /* ======== DEPENDENCIES ======== */
    ...
    constructor(
        ...
        IStaking _staking,
        ITreasury _treasury
    ) NoteKeeper(_authority, _cadt, _gcadt, _staking, _treasury) {
        // save gas for users by bulk approving stake() transactions
        _cadt.approve(address(_staking), 1e45);
    }
     ...
     * @return payout_     the amount of gCADT due
        ...
        )
    {
         ...
         *
         * this is either the number of CADT that the market can sell
    ...
    function create(
        ...
        emit CreateMarket(id_, address(cadt), address(_quoteToken), _market[1]);
    }
     ...
     * @param _id          ID of market
     * @return             price for market in CADT decimals
     *
     ...
     * @param _id          ID of market
     * @return             current debt for market in CADT decimals
     */
