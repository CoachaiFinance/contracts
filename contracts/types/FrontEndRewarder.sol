...
abstract contract FrontEndRewarder is CoachAIAccessControlled {
    /* ========= STATE VARIABLES ========== */
    ...
    IERC20 internal immutable cadt; // reward token

    constructor(ICoachAIAuthority _authority, IERC20 _cadt) CoachAIAccessControlled(_authority) {
        cadt = _cadt;
    }
    ...
    function getReward() external {
        ...
        cadt.transfer(msg.sender, reward);
    }
