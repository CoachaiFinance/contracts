...
contract gCADT is IgCADT, ERC20 {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(address _migrator, address _sCADT) ERC20("Governance CADT", "gCADT", 18) {
     ...
     * @param _sCADT address
     */
    function migrate(address _staking, address _sCADT) external override onlyApproved {
        ...
        require(_sCADT != address(0), "Zero address found");
        sCADT = IsCADT(_sCADT);
    }
    ...
    /**
     * @notice pull index from sCADT token
     */
    ...
    /**
        @notice converts gCADT amount to CADT
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts CADT amount to gCADT
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gCADT::getPriorVotes: not yet determined");
