...
/**
 * A mock version of sCADT, with an over-simplified rebase mechanism, for testing purposes only
 */
contract MockSCADT is ERC20 {
    ...
    constructor(uint256 initialIndex_, uint256 rebasePct_) ERC20("Mock sCADT", "sCADT") {
