...
/**
 *  This contract allows CoachAI seed investors and advisors to claim tokens.
...
contract InvestorClaimV2 is Ownable {
    ...
    function _claim(uint256 _amount) internal returns (uint256 toSend_) {
        ...
        terms[msg.sender].gClaimed = info.gClaimed.add(gCADT.balanceTo(toSend_));
    }
    ...
    function claimed(address _address) public view returns (uint256) {
        return gCADT.balanceFrom(terms[_address].gClaimed);
    }
